...
The above plot shows that we can always envelope $p(x)$ by $Cq(x)$ where $q(x)=\frac{1}{4}e^{-|x|/2}$ is the density for Laplace(0,2). Thus Laplace(0,2) can be our proposal density
...
- Is it possible that if we amplify N(0, 4.84) by a constant, it will cover the target? No. Because of the heavier tail property, the amplified N(0, 4.84) will eventually go under our target distribution
